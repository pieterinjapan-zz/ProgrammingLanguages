...
val test_foldr1 = foldr (fn x => fn v => x + v) 0 [1,2,3,4] = 10
val test_foldr2 = foldr (fn x => fn v => x * v) 1 [1,2,3,4] = 24
...
val test_partition3 = let val charls = partition Char.isUpper (String.explode "slhajJKVHJHhvaln")
